    ...
    <footer className="bg-black text-white px-6 md:px-16 py-10">
      <div className="grid md:grid-cols-3 gap-8 items-center">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <button className="bg-primary cursor-pointer text-black font-medium px-5 py-2 rounded-full flex items-center gap-2 transition">
            Discuss your project
          </button>

          {/* Globe placeholder */}
          <div className="relative   rounded-full overflow-hidden flex items-end justify-center">
            <Image
